...
class InfoMarco:
    def __init__(self, codigo, config):
        ...
        self.urlAV          = 'https://gis.ine.cl/public/rest/services/ESRI/areas_de_rechazo/MapServer/1'
        self.urlCRF         = 'https://gis.ine.cl/public/rest/services/ESRI/areas_de_rechazo/MapServer/2'
